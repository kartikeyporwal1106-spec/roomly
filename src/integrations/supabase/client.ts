...
function getSupabaseUrl(): string | undefined {
  return import.meta.env.VITE_SUPABASE_URL || getProcessEnv("SUPABASE_URL");
}

function getSupabasePublishableKey(): string | undefined {
  return import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY || getProcessEnv("SUPABASE_PUBLISHABLE_KEY");
}
