...
import { r as looksLabels } from "./queries-Ch5H5dkL.mjs";
import { t as Input } from "./input-B8Q2ztVi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/explore-nA_gLr8C.js
...
function Explore() {
	...
	const [floorFilter, setFloorFilter] = (0, import_react.useState)("all");
	const [tagFilters, setTagFilters] = (0, import_react.useState)([]);
